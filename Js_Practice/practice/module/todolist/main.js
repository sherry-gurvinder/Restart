...
console.log("Gurvinder singh",getRoles);
...
function updateResults(){
  ...
  console.log("company",document.querySelector("input[name='role']:checked").value);
  const role = document.querySelector("input[name='role']:checked").value;
  const company = document.querySelector("input[name='company']:checked").value;
  console.log("company",company);

  // If either the company or role is unselected, return.
  if (!document.querySelector("input[name='company']:checked").value || !document.querySelector("input[name='role']:checked").value) { return; }
